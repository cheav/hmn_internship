...
//-------------------------------------------------------------------------------------------------
QWidget *ComboDelegate::createEditor(QWidget *pParent, const QStyleOptionViewItem &rcOption,
...
void ComboDelegate::setModelData(QWidget *pEditor, QAbstractItemModel *pModel,
                                 const QModelIndex &rcIndex) const
{
    QComboBox *pComboBox = qobject_cast<QComboBox*> (pEditor);
    if (pComboBox)
...
void ComboDelegate::updateEditorGeometry(QWidget *pEditor, const QStyleOptionViewItem &rcOption,
                                         const QModelIndex &rcIndex) const
{
